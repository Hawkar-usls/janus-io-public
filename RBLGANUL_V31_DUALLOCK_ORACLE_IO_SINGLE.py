...
# -*- coding: utf-8 -*-
"""
RBLGANUL V31 DUALLOCK ORACLE SINGLE
2026-05-25
...
Run on PC:
  python RBLGANUL_V31_DUALLOCK_ORACLE_SINGLE.py
...
VERSION = "Rblganul V31 DualLock Oracle IO SINGLE 20260526_IOPATH"
SENTINEL = "RBLGANUL_V31_DUALLOCK_ORACLE_IO_SINGLE_20260526_IOPATH"
...
DEFAULT_USER = "JANUS_PUBLIC_WORKER.RblganulV31"
DEFAULT_PASSWORD = "x"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulV31-DualLock"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(prog="RblganulV31DualLockOracle")
    ...
    p.add_argument("--csv-log", default="rblganul_v31_duallock_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="v31_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_v31.json", help="periodic/exit V31 session summary JSON")
    p.add_argument("--janus-brain", default="rblganul_v31_best_brain.json", help="persistent V31 ProofMind elite/bad memory")
    p.add_argument("--registry-dir", default="proofs", help="Janus meta-registry root; defaults to proofs/ so artifacts stay together")
    p.add_argument("--proof-dashboard", default="rblganul_v31_duallock_dashboard.json", help="V31 live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--stride-memory", default="rblganul_v31_zim_stride_memory.json")
    ...
    p.add_argument("--strategy-rates", default="rblganul_v31_strategy_rates.json")
    p.add_argument("--tail-events", default="rblganul_v31_tail_events.jsonl")
    p.add_argument("--dual-lock-memory", default="rblganul_v31_dual_lock_memory.json")
    ...
    p.add_argument("--io-run-name", default="A5_V31_AFTER_V30_IMPORT", help="subfolder for this V31 handoff run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A5_V31_AFTER_V30_IMPORT") or "A5_V31_AFTER_V30_IMPORT")
    ...
    v30_dashboard = v31_io_first_existing([
        old_roots[0] / "proof_dashboard.json",
        old_roots[1] / "proof_dashboard.json",
        old_roots[2] / "a3_janus_full_proof_dashboard.json",
        old_roots[3] / "a4_dual_lock_test_proof_dashboard.json",
        old_roots[4] / "a1_linear_pure_proof_dashboard.json",
    ])
    v30_summary = v31_io_first_existing([
        old_roots[0] / "session_summary.json",
        old_roots[1] / "session_summary.json",
        old_roots[2] / "a3_janus_full_session_summary.json",
        old_roots[3] / "a4_dual_lock_test_session_summary.json",
        old_roots[4] / "a1_linear_pure_session_summary.json",
    ])
    v30_brain = v31_io_first_existing([
        old_roots[0] / "rblganul_v30_best_brain.json",
        old_roots[1] / "rblganul_v30_best_brain.json",
        old_roots[2] / "a3_janus_full_best_brain.json",
        old_roots[3] / "a4_dual_lock_test_best_brain.json",
    ])
    v30_stride = v31_io_first_existing([
        old_roots[0] / "rblganul_v30_zim_stride_memory.json",
        old_roots[1] / "rblganul_v30_zim_stride_memory.json",
        old_roots[2] / "a3_janus_full_stride_memory.json",
        old_roots[3] / "a4_dual_lock_test_stride_memory.json",
    ])
    ...
    defaults = {
        "csv_log": "rblganul_v31_duallock_lab.csv",
        "lockbox": "v31_lockbox.json",
        "session_summary": "session_summary_v31.json",
        "janus_brain": "rblganul_v31_best_brain.json",
        "proof_dashboard": "rblganul_v31_duallock_dashboard.json",
        "stride_memory": "rblganul_v31_zim_stride_memory.json",
        "strategy_rates": "rblganul_v31_strategy_rates.json",
        "tail_events": "rblganul_v31_tail_events.jsonl",
        "dual_lock_memory": "rblganul_v31_dual_lock_memory.json",
    }
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_V31_DUALLOCK_ORACLE_SINGLE.py")
    ...
    global V31_RATEBOOK, V31_TAIL_TRACKER, V31_DUALLOCK_MEMORY
    ...
    while True:
        try:
            ...
            log("stratum", f"connect/init failed: {e}; retrying in 5s")
            try:
                client.sock.close()
            except Exception:
                pass
    ...
    with cf.ProcessPoolExecutor(max_workers=workers) as pool:
        while True:
            ...
            try:
                ...
                log("stratum", f"read failed: {e}; reconnect needed")
                raise
            ...
            while pending:
                ...
                try:
                    ...
                    log("stratum", f"read during round failed: {e}")
                for fut in done:
                    r = fut.result()
                    results.append(r)
