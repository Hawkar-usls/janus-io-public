...
# -*- coding: utf-8 -*-
"""
RBLGANUL A9.3 / V32 BUNNYHOP TACHYON SCOUT WAKE STRICT 50_50 SINGLE
2026-06-04
...
Run on PC:
  python RBLGANUL_A9_3_V32_BUNNYHOP_TACHYON_SCOUT_WAKE_IO_SINGLE.py
...
A9.3 note:
  V32 scheduler/wire behavior is preserved. A9.3 adds a BunnyHop cold-start
...
VERSION = "Rblganul A9.3 V32 BunnyHop Tachyon Scout Wake Strict 50_50 IO SINGLE 20260604"
SENTINEL = "RBLGANUL_A9_3_V32_BUNNYHOP_TACHYON_SCOUT_WAKE_IO_SINGLE_20260604"
...
DEFAULT_USER = "JANUS_PUBLIC_WORKER.RblganulA9_3"
DEFAULT_PASSWORD = "x"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulA9_3-V32BunnyHop5050"
...
class A93BunnyHopAccounting:
    """Fresh-only A9.3 BunnyHop accounting layer.
    ...
    def summary(self, args: argparse.Namespace, client: Any, endurance: Any, proofmind: Any) -> Dict[str, Any]:
        ...
        return {
            "version": VERSION,
            "sentinel": SENTINEL,
            "schema": "a9-3-v32-bunnyhop-tachyon-scout-wake-strict-50-50-accounting-1",
            "written_at_utc": utc_stamp_iso(),
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(prog="RblganulA9_3V32BunnyHopTachyonScoutWake5050")
    ...
    p.add_argument("--csv-log", default="rblganul_a9_3_v32_bunnyhop_tachyon_scout_wake_50_50_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="a9_3_v32_bunnyhop_tachyon_scout_wake_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_a9_3_v32_bunnyhop_tachyon_scout_wake.json", help="periodic/exit A9.3 session summary JSON")
    p.add_argument("--janus-brain", default="rblganul_a9_3_v32_best_brain.json", help="persistent A9.3 ProofMind elite/bad memory")
    p.add_argument("--registry-dir", default="proofs", help="Janus meta-registry root; defaults to proofs/ so artifacts stay together")
    p.add_argument("--proof-dashboard", default="rblganul_a9_3_v32_bunnyhop_tachyon_scout_wake_dashboard.json", help="A9.3/V32 live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--stride-memory", default="rblganul_a9_3_v32_zim_stride_memory.json")
    p.add_argument("--disable-notify-oracle", action="store_true")
    p.add_argument("--notify-pause-window-ms", type=int, default=450)
    # V31 DualLock Oracle flags. A9.3 strict mode uses these as internal JANUS-half
    ...
    p.add_argument("--no-strict-50-50-randomized-traversal-mirror", dest="strict_50_50_random_control", action="store_false",
                   help="disable strict split and fall back to weighted A9.3 lane scheduling")
    ...
    p.add_argument("--strategy-rates", default="rblganul_a9_3_v32_strategy_rates.json")
    p.add_argument("--tail-events", default="rblganul_a9_3_v32_tail_events.jsonl")
    p.add_argument("--dual-lock-memory", default="rblganul_a9_3_v32_dual_lock_memory.json")
    p.add_argument("--a9-accounting-dashboard", default="rblganul_a9_3_v32_bunnyhop_tachyon_scout_wake_accounting.json",
                   help="fresh-only A9.3 strict 50/50 BunnyHop-JANUS-vs-randomized-traversal-mirror accounting dashboard")
    ...
    p.add_argument("--import-v30-state", dest="import_v30_state", action="store_true", default=False, help="import older dashboard/session/proof index at startup; default OFF for clean A9.3 evidence")
    ...
    p.add_argument("--io-run-name", default="A9_3_V32_BUNNYHOP_TACHYON_SCOUT_WAKE_AFTER_A9_1", help="subfolder for this A9.3 BunnyHop scout/wake run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A9_3_V32_BUNNYHOP_TACHYON_SCOUT_WAKE_AFTER_A9_1") or "A9_3_V32_BUNNYHOP_TACHYON_SCOUT_WAKE_AFTER_A9_1")
    ...
    defaults = {
        "csv_log": "rblganul_a9_3_v32_bunnyhop_tachyon_scout_wake_50_50_lab.csv",
        "lockbox": "a9_3_v32_bunnyhop_tachyon_scout_wake_lockbox.json",
        "session_summary": "session_summary_a9_3_v32_bunnyhop_tachyon_scout_wake.json",
        "janus_brain": "rblganul_a9_3_v32_best_brain.json",
        "proof_dashboard": "rblganul_a9_3_v32_bunnyhop_tachyon_scout_wake_dashboard.json",
        "stride_memory": "rblganul_a9_3_v32_zim_stride_memory.json",
        "strategy_rates": "rblganul_a9_3_v32_strategy_rates.json",
        "tail_events": "rblganul_a9_3_v32_tail_events.jsonl",
        "dual_lock_memory": "rblganul_a9_3_v32_dual_lock_memory.json",
        "a9_accounting_dashboard": "rblganul_a9_3_v32_bunnyhop_tachyon_scout_wake_accounting.json",
    }
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_A9_3_V32_BUNNYHOP_TACHYON_SCOUT_WAKE_IO_SINGLE.py")
