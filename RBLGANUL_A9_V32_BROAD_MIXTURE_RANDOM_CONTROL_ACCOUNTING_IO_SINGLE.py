...
# -*- coding: utf-8 -*-
"""
RBLGANUL A9 / V32 BROAD MIXTURE RANDOM CONTROL ACCOUNTING SINGLE
2026-05-27
...
Run on PC:
  python RBLGANUL_A9_V32_BROAD_MIXTURE_RANDOM_CONTROL_ACCOUNTING_IO_SINGLE.py
...
VERSION = "Rblganul A9 V32 Broad-Mixture Random-Control Accounting IO SINGLE 20260604"
SENTINEL = "RBLGANUL_A9_V32_BROAD_MIXTURE_RANDOM_CONTROL_ACCOUNTING_IO_SINGLE_20260604"
...
DEFAULT_USER = "JANUS_PUBLIC_WORKER.RblganulA9"
DEFAULT_PASSWORD = "x"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulA9-V32BroadRandomControl"
...
class A9RandomControlAccounting:
    ...
    def summary(self, args: argparse.Namespace, client: Any, endurance: Any, proofmind: Any) -> Dict[str, Any]:
        ...
        return {
            "version": VERSION,
            "sentinel": SENTINEL,
            "schema": "a9-v32-broad-mixture-random-control-accounting-1",
            "written_at_utc": utc_stamp_iso(),
            "fresh_started_at_utc": self.started_at_utc,
            "fresh_uptime_seconds": max(0.0, time.time() - self.started_wall),
            "objective": "Compare V32 broad scheduler mixture against explicit random_baseline control under the same desktop-load run.",
            "wire_change_required": False,
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(prog="RblganulA9V32BroadMixtureRandomControl")
    ...
    p.add_argument("--csv-log", default="rblganul_a9_v32_broad_mixture_random_control_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="a9_v32_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_a9_v32_broad_mixture_random_control.json", help="periodic/exit A9 session summary JSON")
    p.add_argument("--janus-brain", default="rblganul_a9_v32_best_brain.json", help="persistent A9 ProofMind elite/bad memory")
    p.add_argument("--registry-dir", default="proofs", help="Janus meta-registry root; defaults to proofs/ so artifacts stay together")
    p.add_argument("--proof-dashboard", default="rblganul_a9_v32_broad_mixture_dashboard.json", help="A9/V32 live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--stride-memory", default="rblganul_a9_v32_zim_stride_memory.json")
    ...
    p.add_argument("--strategy-rates", default="rblganul_a9_v32_strategy_rates.json")
    p.add_argument("--tail-events", default="rblganul_a9_v32_tail_events.jsonl")
    p.add_argument("--dual-lock-memory", default="rblganul_a9_v32_dual_lock_memory.json")
    p.add_argument("--a9-accounting-dashboard", default="rblganul_a9_v32_broad_mixture_random_control_accounting.json",
                   help="fresh-only A9 JANUS-vs-random-control accounting dashboard")
    ...
    p.add_argument("--io-run-name", default="A9_V32_BROAD_MIXTURE_RANDOM_CONTROL_AFTER_V32", help="subfolder for this A9 run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A9_V32_BROAD_MIXTURE_RANDOM_CONTROL_AFTER_V32") or "A9_V32_BROAD_MIXTURE_RANDOM_CONTROL_AFTER_V32")
    ...
    defaults = {
        "csv_log": "rblganul_a9_v32_broad_mixture_random_control_lab.csv",
        "lockbox": "a9_v32_lockbox.json",
        "session_summary": "session_summary_a9_v32_broad_mixture_random_control.json",
        "janus_brain": "rblganul_a9_v32_best_brain.json",
        "proof_dashboard": "rblganul_a9_v32_broad_mixture_dashboard.json",
        "stride_memory": "rblganul_a9_v32_zim_stride_memory.json",
        "strategy_rates": "rblganul_a9_v32_strategy_rates.json",
        "tail_events": "rblganul_a9_v32_tail_events.jsonl",
        "dual_lock_memory": "rblganul_a9_v32_dual_lock_memory.json",
        "a9_accounting_dashboard": "rblganul_a9_v32_broad_mixture_random_control_accounting.json",
    }
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_A9_V32_BROAD_MIXTURE_RANDOM_CONTROL_ACCOUNTING_IO_SINGLE.py")
