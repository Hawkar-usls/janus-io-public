...
# -*- coding: utf-8 -*-
"""
RBLGANUL A10 / V34 PHANTOM POOLDAY THETA 50/50 SINGLE
2026-05-27
...
Run on PC:
  python RBLGANUL_A10_V34_PHANTOM_POOLDAY_THETA_50_50_IO_SINGLE.py
...
Phantom note:
  V32 scheduler/wire behavior is preserved. Phantom adds equal-exposure 50/50
  accounting: half of workers run JANUS traversal with PoolDay + Ramanujan theta
  phase telemetry, half run explicit random_baseline control under the same pool
  and desktop-load conditions.
"""
...
VERSION = "Rblganul A10 V34 Phantom PoolDay Theta 50/50 IO SINGLE 20260604"
SENTINEL = "RBLGANUL_A10_V34_PHANTOM_POOLDAY_THETA_50_50_IO_SINGLE_20260604"
...
DEFAULT_USER = "JANUS_PUBLIC_WORKER.RblganulPhantom"
DEFAULT_PASSWORD = "x"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulPhantom-PoolDayTheta50"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(prog="RblganulA10V34PhantomPoolDayTheta50")
    ...
    p.add_argument("--csv-log", default="rblganul_a10_v34_phantom_poolday_theta_50_50_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="a10_v34_phantom_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_a10_v34_phantom_poolday_theta_50_50.json", help="periodic/exit Phantom session summary JSON")
    p.add_argument("--janus-brain", default="rblganul_a10_v34_phantom_best_brain.json", help="persistent Phantom ProofMind elite/bad memory")
    p.add_argument("--registry-dir", default="proofs", help="Janus meta-registry root; defaults to proofs/ so artifacts stay together")
    p.add_argument("--proof-dashboard", default="rblganul_a10_v34_phantom_dashboard.json", help="A10/Phantom live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--stride-memory", default="rblganul_a10_v34_phantom_zim_stride_memory.json")
    ...
    p.add_argument("--strategy-rates", default="rblganul_a10_v34_phantom_strategy_rates.json")
    p.add_argument("--tail-events", default="rblganul_a10_v34_phantom_tail_events.jsonl")
    p.add_argument("--dual-lock-memory", default="rblganul_a10_v34_phantom_dual_lock_memory.json")
    p.add_argument("--a9-accounting-dashboard", default="rblganul_a10_v34_phantom_poolday_theta_50_50_accounting.json",
    ...
    p.add_argument("--io-run-name", default="A10_V34_PHANTOM_POOLDAY_THETA_50_50_AFTER_A9", help="subfolder for this Phantom run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A10_V34_PHANTOM_POOLDAY_THETA_50_50_AFTER_A9") or "A10_V34_PHANTOM_POOLDAY_THETA_50_50_AFTER_A9")
    ...
    defaults = {
        "csv_log": "rblganul_a10_v34_phantom_poolday_theta_50_50_lab.csv",
        "lockbox": "a10_v34_phantom_lockbox.json",
        "session_summary": "session_summary_a10_v34_phantom_poolday_theta_50_50.json",
        "janus_brain": "rblganul_a10_v34_phantom_best_brain.json",
        "proof_dashboard": "rblganul_a10_v34_phantom_dashboard.json",
        "stride_memory": "rblganul_a10_v34_phantom_zim_stride_memory.json",
        "strategy_rates": "rblganul_a10_v34_phantom_strategy_rates.json",
        "tail_events": "rblganul_a10_v34_phantom_tail_events.jsonl",
        "dual_lock_memory": "rblganul_a10_v34_phantom_dual_lock_memory.json",
        "a9_accounting_dashboard": "rblganul_a10_v34_phantom_poolday_theta_50_50_accounting.json",
    }
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_A10_V34_PHANTOM_POOLDAY_THETA_50_50_IO_SINGLE.py")
    ...
    global V31_RATEBOOK, V31_TAIL_TRACKER, V31_DUALLOCK_MEMORY, A9_ACCOUNTING, PHANTOM_CONTEXT
