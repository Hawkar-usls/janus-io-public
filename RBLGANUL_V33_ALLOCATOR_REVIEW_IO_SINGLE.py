...
VERSION = "Rblganul V33 Allocator Review IO SINGLE 20260530_REVIEW"
SENTINEL = "RBLGANUL_V33_ALLOCATOR_REVIEW_IO_SINGLE_20260530_REVIEW"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulV33-AllocatorReview"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(prog="RblganulV33AllocatorReviewOracle")
    ...
    p.add_argument("--csv-log", default="rblganul_v33_allocator_review_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="v33_allocator_review_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_v33_allocator_review.json", help="periodic/exit V33 allocator-review session summary JSON")
    ...
    p.add_argument("--proof-dashboard", default="rblganul_v33_allocator_review_dashboard.json", help="V33 allocator-review live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--allocator-review-path", default="rblganul_v33_allocator_review.json",
    ...
    p.add_argument("--io-run-name", default="A8_V33_ALLOCATOR_REVIEW_AFTER_V33_SHADOW", help="subfolder for this V33 allocator-review handoff run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A8_V33_ALLOCATOR_REVIEW_AFTER_V33_SHADOW") or "A8_V33_ALLOCATOR_REVIEW_AFTER_V33_SHADOW")
    ...
    defaults = {
        "csv_log": "rblganul_v33_allocator_review_lab.csv",
        "lockbox": "v33_allocator_review_lockbox.json",
        "session_summary": "session_summary_v33_allocator_review.json",
        "janus_brain": "rblganul_v33_best_brain.json",
        "proof_dashboard": "rblganul_v33_allocator_review_dashboard.json",
        ...
        "allocator_review_path": "rblganul_v33_allocator_review.json",
    }
    ...
    info = {
        "schema": "v33-allocator-review-io-path-bootstrap-1",
        "version": VERSION,
        "sentinel": SENTINEL,
        "created_at_utc": utc_stamp_iso(),
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_V33_ALLOCATOR_REVIEW_IO_SINGLE.py")
    ...
    global V31_RATEBOOK, V31_TAIL_TRACKER, V31_DUALLOCK_MEMORY, V33_TACHYON_SHADOW, V33_ALLOCATOR_REVIEW
