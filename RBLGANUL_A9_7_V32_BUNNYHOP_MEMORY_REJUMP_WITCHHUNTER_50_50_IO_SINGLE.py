...
# -*- coding: utf-8 -*-
"""
RBLGANUL A9.7 / V32 BUNNYHOP MEMORY REJUMP WITCHHUNTER STRICT 50_50 SINGLE
2026-06-05
...
Run on PC:
  python RBLGANUL_A9_7_V32_BUNNYHOP_MEMORY_REJUMP_WITCHHUNTER_50_50_IO_SINGLE.py
...
A9.7 note:
  V32 scheduler/wire behavior is preserved. A9.7 keeps the BunnyHop Memory ReJump
...
VERSION = "Rblganul A9.7 V32 BunnyHop Memory ReJump WitchHunter Strict 50_50 IO SINGLE 20260605"
SENTINEL = "RBLGANUL_A9_7_V32_BUNNYHOP_MEMORY_REJUMP_WITCHHUNTER_50_50_IO_SINGLE_20260605"
...
DEFAULT_USER = "JANUS_PUBLIC_WORKER.RblganulA9_7"
DEFAULT_PASSWORD = "x"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulA9_7-V32ReJumpWitchHunter5050"
...
class A97BunnyHopAccounting:
    """Fresh-only A9.7 BunnyHop accounting layer.
    ...
    def summary(self, args: argparse.Namespace, client: Any, endurance: Any, proofmind: Any) -> Dict[str, Any]:
        ...
        return {
            "version": VERSION,
            "sentinel": SENTINEL,
            "schema": "a9-7-v32-bunnyhop-memory-rejump-witchhunter-strict-50-50-accounting-1",
            "written_at_utc": utc_stamp_iso(),
...
class WitchHunter:
    ...
    @staticmethod
    def group_name(lane: Any, strategy: Any = None) -> str:
        return A97BunnyHopAccounting.group_name(lane, strategy)

    @staticmethod
    def lane_key(lane: Any, strategy: Any, sector: Any, cfg_name: Any) -> str:
        return A97BunnyHopAccounting.lane_key(lane, strategy, sector, cfg_name)
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        return {
            "version": VERSION,
            "sentinel": SENTINEL,
            "schema": "a9-7-witchhunter-dark-tail-observer-1",
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(prog="RblganulA9_7V32BunnyHopTachyonScoutWake5050")
    ...
    p.add_argument("--csv-log", default="rblganul_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50.json", help="periodic/exit A9.7 session summary JSON")
    p.add_argument("--janus-brain", default="rblganul_a9_7_v32_best_brain.json", help="persistent A9.7 ProofMind elite/bad memory")
    p.add_argument("--registry-dir", default="proofs", help="Janus meta-registry root; defaults to proofs/ so artifacts stay together")
    p.add_argument("--proof-dashboard", default="rblganul_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_dashboard.json", help="A9.7/V32 live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--stride-memory", default="rblganul_a9_7_v32_zim_stride_memory.json")
    p.add_argument("--disable-notify-oracle", action="store_true")
    p.add_argument("--notify-pause-window-ms", type=int, default=450)
    # V31 DualLock Oracle flags. A9.7 strict mode uses these as internal JANUS-half
    ...
    p.add_argument("--no-strict-50-50-randomized-traversal-mirror", dest="strict_50_50_random_control", action="store_false",
                   help="disable strict split and fall back to weighted A9.7 lane scheduling")
    ...
    p.add_argument("--strategy-rates", default="rblganul_a9_7_v32_strategy_rates.json")
    p.add_argument("--tail-events", default="rblganul_a9_7_v32_tail_events.jsonl")
    p.add_argument("--dual-lock-memory", default="rblganul_a9_7_v32_dual_lock_memory.json")
    p.add_argument("--a9-accounting-dashboard", default="rblganul_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_accounting.json",
                   help="fresh-only A9.7 strict 50/50 BunnyHop-JANUS-vs-randomized-traversal-mirror accounting dashboard")
    p.add_argument("--disable-a9-accounting", action="store_true",
                   help="disable A9 accounting layer; scheduler/wire are unchanged")
    p.add_argument("--witchhunter-dashboard", default="rblganul_a9_7_v32_witchhunter_dark_tail.json",
                   help="observer-only rejected/stale/drop dark-tail dashboard JSON")
    p.add_argument("--witchhunter-events", default="rblganul_a9_7_v32_witchhunter_dark_tail_events.jsonl",
    ...
    p.add_argument("--enable-bunnyhop-rescout", dest="bunnyhop_rescout_enable", action="store_true", default=True,
                   help="A9.7 default ON: after wake stalls, briefly re-enter JANUS-shaped re-scout instead of staying only in broad mixture")
    p.add_argument("--disable-bunnyhop-rescout", dest="bunnyhop_rescout_enable", action="store_false",
                   help="disable A9.7 Memory ReJump and behave like A9.6 scout/wake")
    ...
    p.add_argument("--import-v30-state", dest="import_v30_state", action="store_true", default=False, help="import older dashboard/session/proof index at startup; default OFF for clean A9.7 evidence")
    ...
    p.add_argument("--io-run-name", default="A9_7_V32_BUNNYHOP_MEMORY_REJUMP_WITCHHUNTER_50_50_AFTER_A9_6", help="subfolder for this A9.7 BunnyHop scout/wake run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A9_7_V32_BUNNYHOP_MEMORY_REJUMP_WITCHHUNTER_50_50_AFTER_A9_6") or "A9_7_V32_BUNNYHOP_MEMORY_REJUMP_WITCHHUNTER_50_50_AFTER_A9_6")
    ...
    defaults = {
        "csv_log": "rblganul_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_lab.csv",
        "lockbox": "a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_lockbox.json",
        "session_summary": "session_summary_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50.json",
        "janus_brain": "rblganul_a9_7_v32_best_brain.json",
        "proof_dashboard": "rblganul_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_dashboard.json",
        "stride_memory": "rblganul_a9_7_v32_zim_stride_memory.json",
        "strategy_rates": "rblganul_a9_7_v32_strategy_rates.json",
        "tail_events": "rblganul_a9_7_v32_tail_events.jsonl",
        "dual_lock_memory": "rblganul_a9_7_v32_dual_lock_memory.json",
        "a9_accounting_dashboard": "rblganul_a9_7_v32_bunnyhop_memory_rejump_witchhunter_50_50_accounting.json",
        "witchhunter_dashboard": "rblganul_a9_7_v32_witchhunter_dark_tail.json",
        "witchhunter_events": "rblganul_a9_7_v32_witchhunter_dark_tail_events.jsonl",
    }
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_A9_7_V32_BUNNYHOP_MEMORY_REJUMP_WITCHHUNTER_50_50_IO_SINGLE.py")
    ...
    A9_ACCOUNTING = None if bool(args.disable_a9_accounting) else A97BunnyHopAccounting(args.a9_accounting_dashboard)
