...
# -*- coding: utf-8 -*-
"""
RBLGANUL A10.1 / V34 FULL PHANTOM OBSERVER PACK SINGLE
2026-05-27
...
Run on PC:
  python RBLGANUL_A10_1_V34_FULL_PHANTOM_OBSERVER_PACK_IO_SINGLE.py
...
Full Phantom note:
  V32 scheduler/wire behavior is preserved. A10.1 keeps equal-exposure 50/50
  accounting and adds the observer pack: exact recipe scoreboard, fresh TailGEX,
  exposure watch, duplicate-risk watch, PoolDay, and Ramanujan theta telemetry.
  These observers do not apply allocator weights or change submit behavior.
"""
...
VERSION = "Rblganul A10.1 V34 Full Phantom Observer Pack IO SINGLE 20260604"
SENTINEL = "RBLGANUL_A10_1_V34_FULL_PHANTOM_OBSERVER_PACK_IO_SINGLE_20260604"
...
DEFAULT_USER = "JANUS_PUBLIC_WORKER.RblganulPhantomFull"
DEFAULT_PASSWORD = "x"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulPhantomFull-Observer50"
...
class PoolDayThetaContext:
    ...
    def snapshot(self, job: "Job", pool_diff: float, round_id: int) -> Dict[str, Any]:
        now = now_ms()
...
class PhantomPoolDayThetaAccounting:
    ...
    def summary(self, args: argparse.Namespace, client: Any, endurance: Any, proofmind: Any) -> Dict[str, Any]:
        ...
        return {
            "version": VERSION,
            "sentinel": SENTINEL,
            "schema": "a10-v34-phantom-poolday-theta-50-50-accounting-1",
            "written_at_utc": utc_stamp_iso(),
...
class FullPhantomObserverPack:
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        return {
            "version": VERSION,
            "sentinel": SENTINEL,
            "schema": "a10-1-v34-full-phantom-observer-pack-1",
            "written_at_utc": utc_stamp_iso(),
            "fresh_started_at_utc": self.started_at_utc,
            "fresh_uptime_seconds": max(0.0, time.time() - self.started_wall),
            "wire_change_required": False,
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(prog="RblganulA10_1V34FullPhantomObserverPack")
    ...
    p.add_argument("--csv-log", default="rblganul_a10_1_v34_full_phantom_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="a10_1_v34_full_phantom_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_a10_1_v34_full_phantom.json", help="periodic/exit Full Phantom session summary JSON")
    p.add_argument("--janus-brain", default="rblganul_a10_1_v34_full_phantom_best_brain.json", help="persistent Full Phantom ProofMind elite/bad memory")
    p.add_argument("--registry-dir", default="proofs", help="Janus meta-registry root; defaults to proofs/ so artifacts stay together")
    p.add_argument("--proof-dashboard", default="rblganul_a10_1_v34_full_phantom_dashboard.json", help="A10.1/Full Phantom live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--stride-memory", default="rblganul_a10_1_v34_full_phantom_zim_stride_memory.json")
    ...
    p.add_argument("--strategy-rates", default="rblganul_a10_1_v34_full_phantom_strategy_rates.json")
    p.add_argument("--tail-events", default="rblganul_a10_1_v34_full_phantom_tail_events.jsonl")
    p.add_argument("--dual-lock-memory", default="rblganul_a10_1_v34_full_phantom_dual_lock_memory.json")
    p.add_argument("--a9-accounting-dashboard", default="rblganul_a10_1_v34_full_phantom_50_50_accounting.json",
    ...
    p.add_argument("--phantom-observer-path", default="rblganul_a10_1_v34_full_phantom_observer_pack.json",
                   help="A10.1 full observer-pack dashboard JSON")
    ...
    p.add_argument("--import-v30-state", dest="import_v30_state", action="store_true", default=True, help="import V30 dashboard/session/proof index at startup and continue counters")
    ...
    p.add_argument("--io-run-name", default="A10_1_V34_FULL_PHANTOM_OBSERVER_PACK_AFTER_A10", help="subfolder for this Full Phantom run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A10_1_V34_FULL_PHANTOM_OBSERVER_PACK_AFTER_A10") or "A10_1_V34_FULL_PHANTOM_OBSERVER_PACK_AFTER_A10")
    ...
    defaults = {
        "csv_log": "rblganul_a10_1_v34_full_phantom_lab.csv",
        "lockbox": "a10_1_v34_full_phantom_lockbox.json",
        "session_summary": "session_summary_a10_1_v34_full_phantom.json",
        "janus_brain": "rblganul_a10_1_v34_full_phantom_best_brain.json",
        "proof_dashboard": "rblganul_a10_1_v34_full_phantom_dashboard.json",
        "stride_memory": "rblganul_a10_1_v34_full_phantom_zim_stride_memory.json",
        "strategy_rates": "rblganul_a10_1_v34_full_phantom_strategy_rates.json",
        "tail_events": "rblganul_a10_1_v34_full_phantom_tail_events.jsonl",
        "dual_lock_memory": "rblganul_a10_1_v34_full_phantom_dual_lock_memory.json",
        "a9_accounting_dashboard": "rblganul_a10_1_v34_full_phantom_50_50_accounting.json",
        "phantom_observer_path": "rblganul_a10_1_v34_full_phantom_observer_pack.json",
    }
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_A10_1_V34_FULL_PHANTOM_OBSERVER_PACK_IO_SINGLE.py")
    ...
    with cf.ProcessPoolExecutor(max_workers=workers) as pool:
        while True:
            ...
            if PHANTOM_CONTEXT is not None and not bool(getattr(args, "disable_poolday", False)):
                poolday_snapshot = PHANTOM_CONTEXT.snapshot(job, client.pool_diff, round_id)
            else:
                poolday_snapshot = {
                    "enabled": False,
                    "job_id": job.job_id,
