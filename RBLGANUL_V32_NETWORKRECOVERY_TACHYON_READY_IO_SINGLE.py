...
# -*- coding: utf-8 -*-
"""
RBLGANUL V32 NETWORKRECOVERY TACHYON-READY ORACLE SINGLE
2026-05-27
...
Run on PC:
  python RBLGANUL_V32_NETWORKRECOVERY_TACHYON_READY_IO_SINGLE.py
...
VERSION = "Rblganul V32 NetworkRecovery Tachyon-Ready IO SINGLE 20260527_IOPATH"
SENTINEL = "RBLGANUL_V32_NETWORKRECOVERY_TACHYON_READY_IO_SINGLE_20260527_IOPATH"
...
DEFAULT_USER = "JANUS_PUBLIC_WORKER.RblganulV32"
DEFAULT_PASSWORD = "x"
...
DEFAULT_SUBSCRIBE_TAG = "NerdMinerV2/RblganulV32-NetworkRecovery"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--csv-log", default="rblganul_v32_networkrecovery_lab.csv")
    p.add_argument("--proofs-dir", default="proofs", help="directory for accepted-share proof JSON files")
    p.add_argument("--lockbox", default="v32_lockbox.json", help="startup configuration lockbox JSON")
    p.add_argument("--session-summary", default="session_summary_v32.json", help="periodic/exit V32 session summary JSON")
    p.add_argument("--janus-brain", default="rblganul_v32_best_brain.json", help="persistent V32 ProofMind elite/bad memory")
    p.add_argument("--registry-dir", default="proofs", help="Janus meta-registry root; defaults to proofs/ so artifacts stay together")
    p.add_argument("--proof-dashboard", default="rblganul_v32_networkrecovery_dashboard.json", help="V32 live dashboard JSON for long unattended runs")
    ...
    p.add_argument("--stride-memory", default="rblganul_v32_zim_stride_memory.json")
    ...
    p.add_argument("--strategy-rates", default="rblganul_v32_strategy_rates.json")
    p.add_argument("--tail-events", default="rblganul_v32_tail_events.jsonl")
    p.add_argument("--dual-lock-memory", default="rblganul_v32_dual_lock_memory.json")
    ...
    p.add_argument("--io-run-name", default="A6_V32_NETWORKRECOVERY_AFTER_V31", help="subfolder for this V32 handoff run")
...
def v31_io_prepare_paths(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    run_name = str(getattr(args, "io_run_name", "A6_V32_NETWORKRECOVERY_AFTER_V31") or "A6_V32_NETWORKRECOVERY_AFTER_V31")
    ...
    defaults = {
        "csv_log": "rblganul_v32_networkrecovery_lab.csv",
        "lockbox": "v32_lockbox.json",
        "session_summary": "session_summary_v32.json",
        "janus_brain": "rblganul_v32_best_brain.json",
        "proof_dashboard": "rblganul_v32_networkrecovery_dashboard.json",
        "stride_memory": "rblganul_v32_zim_stride_memory.json",
        "strategy_rates": "rblganul_v32_strategy_rates.json",
        "tail_events": "rblganul_v32_tail_events.jsonl",
        "dual_lock_memory": "rblganul_v32_dual_lock_memory.json",
    }
...
def main() -> None:
    ...
    log("run", "no long command needed: python RBLGANUL_V32_NETWORKRECOVERY_TACHYON_READY_IO_SINGLE.py")
